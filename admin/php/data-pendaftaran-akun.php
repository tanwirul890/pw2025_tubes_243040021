...
<main class="col-lg-10 ms-lg-auto px-lg-4" style="transition: margin-left 0.3s;">
  ...
  <div class="header text-white d-flex justify-content-between align-items-center">
    ...
    <a href="tambah_akun.php" class="btn btn-light btn-custom shadow-sm">+ Tambah Akun</a>
  </div>
  <div class="card-body">
    ...
    <?php if ($total_pendaftaran > 0): ?>
      ...
      <td class="aksi-btns">
        <!-- Tombol Ubah Data -->
        <a href="ubah-akun.php?id=<?= $akun['id']; ?>"
           class="btn btn-success btn-sm btn-custom" title="Ubah Data">
          <i class="bi bi-pencil-square"></i>
        </a>
        <!-- Tombol Hapus Data -->
        <a href="hapus-akun.php?id=<?= $akun['id']; ?>"
  ...
  <!-- Akhir Tabel Data Pendaftaran Akun -->
</main>
<!-- Akhir Konten Utama -->
</div>
</div>
