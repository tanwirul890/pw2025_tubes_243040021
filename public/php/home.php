...
<section id="produk" class="py-5 bg-light">
  <div class="container">
    <h2 class="text-center fw-bold mb-5 text-success display-5" data-aos="fade-down">Produk Unggulan</h2>
    <div class="row g-4">
      <!-- Produk 1 -->
...
<section class="container my-5 section-card">
  <div class="row align-items-center">
    <div class="col-md-6" data-aos="fade-right">
      <img src="../img/1.png" class="img-fluid rounded shadow-sm" alt="Tentang Kami"></div>
...
<!-- Keunggulan -->
<section class="container my-5 section-card">
  <h2 class="text-center fw-bold text-success mb-4"  data-aos="fade-down">Kenapa Memilih Kami?</h2>
